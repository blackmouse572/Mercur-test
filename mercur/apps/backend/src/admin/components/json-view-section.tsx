...
import React, { CSSProperties, MouseEvent, Suspense, useState } from 'react'
...
type JsonViewSectionProps = {
  ...
  headingLevel?: React.ComponentProps<typeof Heading>['level']
...
export const JsonViewSection = ({
  ...
  return (
    <Container
      className={clx('flex items-center justify-between px-6 py-4', className)}
      {...props}
    >
      <div className="flex items-center gap-x-4">
        {title ?? <Heading level={headingLevel}>JSON</Heading>}
